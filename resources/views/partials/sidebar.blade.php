<div id="left-sidebar" class="sidebar">
    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            ...
            <div class="dropdown">
                <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown" aria-expanded="false"><strong>Welcome, </strong><br><strong>{{ ($user->BusinessName)?$user->BusinessName:'User' }}</strong></a>
