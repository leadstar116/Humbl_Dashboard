            ...
            <div class="card">
                ...
                <div class="body">
                    <label class="text-muted">Business Name </label>
                      <input type="text" placeholder="Enter Business Name" name="name">
                    <hr>
                    <label class="text-muted">Tagline </label>
                      <input type="text" placeholder="Example: Where Fresh Meets Fun" name="tagline">
                    <hr>
                    <label class="text-muted">Email Address </label>
                      <input type="text" placeholder="Primary Contact Email" name="email">
                    <hr>
                    <label class="text-muted">Phone Number </label>
                      <input type="text" placeholder="Example: 555-555-5555" name="phone">
                    <hr>
                    <button type="primary" class="btn btn-primary left-btn">
                        Save
                    </button>
                    <button type="primary" class="btn btn-primary left-btn">
                        Reset
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                              ...
                              <button type="primary" class="btn btn-primary btn-save-continue">
                                Add Department
                              </button>
                            </div>
                        </div>
